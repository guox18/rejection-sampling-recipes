...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_path",
        type=str,
        default="/mnt/shared-storage-user/songdemin/user/guoxu/public/rejection-sampling-recipes/delivery/instruction_following_ifbench/collect/feasible_and_pass/feasible_and_pass.jsonl",
        help="输入文件路径",
    )
    parser.add_argument(
        "--output_path",
        type=str,
        default="/mnt/shared-storage-user/songdemin/user/guoxu/public/rejection-sampling-recipes/delivery/instruction_following_ifbench/collect/feasible_and_pass_messages/feasible_and_pass.jsonl",
        help="输出文件路径",
    )
    parser.add_argument(
        "--process_fn",
        type=str,
        default="ddm_to_messages",
        choices=["ddm_to_messages", "messages_to_ddm"],
        help="处理函数",
    )
