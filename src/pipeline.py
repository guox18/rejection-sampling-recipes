...
class Pipeline:
    ...
    def run(self, input_path: str, output_path: str = None):
        ...
        ds = ds.map_batches(add_resume_id, batch_format="pandas")
        ...
        if processed_ids:
            ...
            ds = ds.map_batches(filter_processed, batch_format="pandas")
        ...
        with open(output_path, "a") as f:
            try:
                for row in ds.iter_rows():
                    ...
                    if item.get("_failed"):
                        failed_rows += 1
                        print(f"[Pipeline] Skipping failed item: {item.get('_error', 'Unknown error')}")
                        continue
            ...
            def __call__(self, batch):
                ...
                if normal_items:
                    try:
                        ...
                        results = [
                            {**item, "_failed": True, "_error": str(e)}
